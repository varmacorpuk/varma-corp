...
9. Desktop: vendored Parcha-ai/ai-office floor (`rpg-tileset.png` — the photographed teal office, framed window, peach chat panel, bottom portrait bar) with pixel-agents Metro City people for Varma staff only (person · department). Click to right-hand peach panel; office remains visible; no covering overlay; chat hits the same employee runtime. Chat history is loaded from the database. No Talk/voice. Click never grants authority. No sitcom names.
