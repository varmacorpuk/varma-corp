...
29. Until the Board picks a session rule, SHEL.L, AZN.L, ULVR.L deny after London cash close (`LSE_SESSION_RULE_UNSET`, deny-until-resolved). Not an all-day hold. Not a split flatten-clock default — Addendum C stays flatten-at-US-close, not 16:30. Before 16:30 they wait on `PAPER_EXECUTION_CLOSED` like US names. Do not invent US listings. Employees cannot write this lock. PAPER execution stays CLOSED. Documents 03/08 (brains/people) remain the priority.
